...
#define STRING_CONFIG_H_AUTHOR "(Joel Neuhaus 04.12.2020 SKR 1.4 Turbo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 5 SKR 1.4"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 43.46
  #define DEFAULT_bedKi 7.76
  #define DEFAULT_bedKd 162.26
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37.88, -6.5, -1.3 }
...
#define XY_PROBE_FEEDRATE (260*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (20*60)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST/ (5/2))
...
// Preheat Constants
#define PREHEAT_1_LABEL       "PLA/BioTEC"
